...
namespace MaroonSeal.Packages.DataStructures.NodeGraphs.Traversal {
    public class NodeGraphAStarTraversal
    {
        ...
        static public List<TData> FindNodePath<TData>(NodeGraphDirectionalWeighted<TData> _graph, TData _startNode, TData _endNode, Func<TData, TData, float> _heuristic) {
            return FindNodePath(_graph, _startNode, _endNode, _heuristic, out float distance);
        }

        static public List<TData> FindNodePath<TData>(NodeGraphDirectionalWeighted<TData> _graph, TData _startNode, TData _endNode, Func<TData, TData, float> _heuristic, out float _distance) {
            List<int> pathIndexes = FindPath(_graph, _graph[_startNode], _graph[_endNode], _heuristic, out _distance);
        ...
        static public List<int> FindPath<TData>(NodeGraphDirectionalWeighted<TData> _graph, int _startNode, int _endNode, Func<TData, TData, float> _heuristic) {
            return FindPath(_graph, _startNode, _endNode, _heuristic, out float distance);
        }

        static public List<int> FindPath<TData>(NodeGraphDirectionalWeighted<TData> _graph, int _startNode, int _endNode, Func<TData, TData, float> _heuristic, out float _distance) {
